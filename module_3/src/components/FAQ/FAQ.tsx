...
const FAQ = () => {
    return (
        <div className="faq">
            <h2 className="faq__header">Issuing and receiving a card</h2>
            <AccordionWrapper>
                <Accordion
                ...
                />
                <Divider thickness={1} />
                <Accordion title="In what currency can I issue a card?" info="In rubles, dollars or euro" />
                <Divider thickness={1} />
                <Accordion
            ...
            <h2 className="faq__header">Using a credit card</h2>
            <AccordionWrapper>
                <Accordion
